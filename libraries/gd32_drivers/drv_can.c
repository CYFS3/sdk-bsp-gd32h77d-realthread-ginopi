...
#if defined(SOC_GD32H77DIW) /* APB2 300MHz(max) */
...
#if defined(BSP_USING_CAN0) && !defined(SOC_GD32H77DIW)
...
#if defined(SOC_GD32H77DIW) && defined(RT_CAN_USING_CANFD)
