 ...
 *
 * Dual-channel PWM output test for the GD32H77D EVB.
 */

#include <rtdevice.h>
#include <rtthread.h>

#if defined(BSP_USING_PWM2) && defined(BSP_USING_PWM30)
...
static int pwm_dual_test(int argc, char *argv[])
{
    ...
    rt_kprintf("enable BSP_USING_PWM2 and BSP_USING_PWM30 first\n");
    return -RT_ERROR;
}
