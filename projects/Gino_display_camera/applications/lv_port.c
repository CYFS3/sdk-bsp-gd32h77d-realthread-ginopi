 ...
 * 2026-09-08     CYFS         port the LVGL camera preview with internal rendering and IPA updates
 */
...
#define LVGL_DISPLAY_WIDTH              LV_HOR_RES_MAX
#define LVGL_DISPLAY_HEIGHT             LV_VER_RES_MAX
#define LVGL_USE_DIRECT_FRAMEBUFFER     1
#endif
...
void lv_user_gui_init(void)
{
    ...
    extern rt_err_t ov7670_preview_request_start(void);

    ov7670_preview_init();
    if (ov7670_preview_request_start() != RT_EOK)
    {
        LOG_W("OV7670 preview is not ready to auto-start");
    }
#endif
}
